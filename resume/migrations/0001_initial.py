# Generated by Django 3.2.5 on 2021-08-11 22:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.IntegerField(blank=True, choices=[(0, 'Software tool'), (1, 'Programing Language'), (2, 'Software framework'), (3, 'Architecture / Paradigm'), (4, 'Language'), (5, 'Soft skill')], null=True, verbose_name='Skill type')),
